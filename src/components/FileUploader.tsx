    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-6 py-12 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 rounded-2xl shadow-2xl relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          ...
          />
          <motion.div
            className="absolute top-20 right-20 w-16 h-16 bg-purple-400 rounded-full"
            animate={{
              scale: [1.2, 1, 1.2],
              opacity: [0.4, 0.2, 0.4],
            }}
          ...
          />
          <motion.div
            className="absolute bottom-20 left-20 w-12 h-12 bg-green-400 rounded-full"
            animate={{
              scale: [1, 1.3, 1],
              opacity: [0.2, 0.5, 0.2],
            }}
        ...
        {!selectedFile ? (
          <motion.div
            className={`
              ...
              ${isDragging 
                ...
                : 'border-gray-300 dark:border-gray-600 hover:border-primary/50 hover:bg-primary/5 shadow-xl'
              }
          ...
          >
            <div className="flex flex-col items-center justify-center space-y-8">
              <motion.div 
                className="bg-gradient-to-br from-primary/20 to-primary/10 p-8 rounded-full shadow-lg"
              ...
              >
                <Button 
                  type="button" 
                  size="lg"
                  className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white shadow-lg hover:shadow-xl transition-all duration-300 px-8 py-3 text-lg"
                >
          ...
          <motion.div
            className="border-0 rounded-2xl p-10 bg-white shadow-2xl"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
            transition={{ duration: 0.4 }}
              ...
              <div className="space-y-6 w-full max-w-md">
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    >
                      {uploadState === 'ready' ? (
                        <span className="text-sm bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300 px-3 py-1 rounded-full flex items-center font-medium">
                          <Check className="mr-1 h-4 w-4" />
                          Ready to Process
                        </span>
                      ) : (
                        <span className="text-sm bg-red-100 text-red-800 dark:bg-red-900/50 dark:text-red-300 px-3 py-1 rounded-full flex items-center font-medium">
                  ...
                  <motion.div 
                    className="flex items-center border-2 border-slate-200 rounded-xl p-4 bg-gradient-to-r from-slate-50 to-white shadow-sm"
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                  ...
                  >
                    <Button 
                      ...
                      className="w-full py-3 bg-white hover:bg-slate-50 shadow-md border-slate-200"
                    >
                  ...
                  >
                    <Button 
                      ...
                      className="w-full py-3 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary/80 disabled:from-slate-300 disabled:to-slate-400 shadow-lg hover:shadow-xl transition-all duration-300"
                    >
